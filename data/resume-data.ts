...
export const RESUME_DATA = {
  ...
  graph: {
    nodes: [
      ...
      { id: "TypeScript", label: "TypeScript", type: "tech" },
      { id: "Next.js", label: "Next.js", type: "tech" },
      { id: "React Query", label: "React Query", type: "tech" },
      { id: "React Flow", label: "React Flow", type: "tech" },
      { id: "ECharts", label: "ECharts", type: "tech" },
      { id: "Konva", label: "Konva", type: "tech" },
      { id: "Vue.js", label: "Vue.js", type: "tech" },
      { id: "ArcGIS", label: "ArcGIS", type: "tech" },
      { id: "Shadcn", label: "Shadcn UI", type: "tech" },
